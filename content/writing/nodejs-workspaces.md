...
It exists in most of the package managers, including [pnpm](https://pnpm.io/workspaces) and [Yarn](https://yarnpkg.com/features/workspaces). They can also be integrated with build tools such as [Turborepo](https://turbo.build/repo) and [Nx](https://nx.dev/).
...
>
> [![A recommendation to install dependencies at the root of a monorepo (full-size image)](/images/nodejs-workspaces-img.png)](/images/nodejs-workspaces-img.png)
>
